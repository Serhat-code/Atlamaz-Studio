...
export const faqs = [
  ...
  },
  {
    ...
    reponse: "3 itérations par projet — chacune correspond à un cycle de retours sur l'ensemble du projet, pas à une seule correction. En pratique ce volume suffit car le brief est affiné en amont. Les itérations supplémentaires sont facturées 50€ par demande.",
    serviceLie: null,
  },
  ...
  // ── Après livraison ───────────────────────────────────────
  {
    ...
    reponse: "149€/mois sans engagement : sauvegarde hebdomadaire automatique restaurable, mises à jour de sécurité, surveillance de disponibilité en continu, alerte immédiate en cas de panne, 1h de modifications de contenu mensuelle et rapport d'intervention.",
  ...
  },
  {
    ...
    reponse: "Avec le suivi de maintenance, la surveillance détecte la panne et déclenche une intervention prioritaire. Sans contrat de maintenance, une intervention ponctuelle reste possible, facturée à l'heure. Dans les deux cas, une sauvegarde récente limite la perte de données.",
    serviceLie: 'maintenance-site-web',
  },
  {
    id: 13,
    ...
    reponse: "Oui : ajout de pages, nouvelles fonctionnalités, refonte partielle — chaque évolution fait l'objet d'un devis dédié. Le suivi de maintenance couvre les ajustements mineurs via l'heure de modification mensuelle incluse.",
    serviceLie: null,
  },
  {
    id: 14,
  ...
  },
  {
    ...
    reponse: "Le premier périmètre publie sur le Play Store (Android). Le périmètre complet publie sur les deux stores. Validation : quelques heures sur le Play Store, 1 à 3 jours sur l'App Store — ces délais sont fixés par Apple et Google, indépendants du développement.",
    serviceLie: 'creation-application-mobile',
  },
  {
    id: 17,
    ...
    reponse: "Une application Android de 3 à 5 écrans publiée sur le Play Store démarre à 8 000€, livrée en 6 semaines. Une application iOS et Android avec authentification, backend Supabase et notifications push démarre à 15 000€, livrée en 8 semaines. Pour les plateformes les plus complexes, certains projets vont jusqu'à 50 000€ — un devis est alors établi sur mesure.",
    serviceLie: 'creation-application-mobile',
  },
];
