...
export const en = {
  ...
  studio: {
    ...
    meta: {
      ...
      description: 'Atlamaz Studio is a React and React Native web studio based in Lyon. Custom architecture, measured performance, a single technical contact.',
    },
    pageEyebrow: 'Web studio · Lyon, France',
    pageTitle: 'You talk directly to the team that builds your project.',
    pageSubtitle: "No middleman between your problem and the code that solves it. You talk directly to the team architecting, building, and shipping your site.",
    quote: 'A slow or poorly structured site loses customers before anyone finishes reading it. We build architectures that hold up over time, not mockups that only look good in a demo.',
  ...
  merci: {
    ...
    subtitle: "We are reviewing it now and will reply within 48h with an initial take on your project. In the meantime, feel free to browse the case studies.",
